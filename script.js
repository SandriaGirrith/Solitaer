...
<head>
    ...
    <style>
        /* Grundlegende Stile für das Spielfeld */
        .pile {
        ...
        .card {
            width: 71px;
            height: 96px;
            margin-bottom: -70px; /* Überlappung der Karten */
        }
        .face-down {
    ...
    <!-- Confetti-Bibliothek für Gewinnanimation -->
...
<body>
    ...
    <div id="win-screen" class="hidden">Gewonnen!</div>
    <div id="restart-screen" class="hidden">Keine Züge mehr möglich!</div>
    <button id="new-game-win">Neues Spiel</button>
    <button id="new-game-restart">Neues Spiel</button>
